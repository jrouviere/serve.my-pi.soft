...
/* JRO: little trick to improve critical system interrupt:
freertos will now only disable lowest level interrupt, and might be preempted by
time critical interrupt, that implies we can't use any OS function within higher
level interrupt.*/
